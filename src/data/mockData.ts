...
export const CLIENTS: Client[] = [
  { id: 'c1', name: 'Simba Dube', email: 'simba.dube@gmail.com', phone: '+263 71 678 9012', nationalId: '63-1234567A00', dob: '1990-03-15', address: '12 Borrowdale Rd, Harare', occupation: 'Engineer', insurer: 'Motions', createdAt: '2024-01-10', policyCount: 2, status: 'active' },
  { id: 'c2', name: 'Nomsa Ndlovu', email: 'nomsa.ndlovu@gmail.com', phone: '+263 77 234 5678', nationalId: '78-2345678B00', dob: '1978-07-22', address: '45 Bulawayo Ave, Bulawayo', occupation: 'Teacher', insurer: 'CBZ Life', createdAt: '2024-02-05', policyCount: 3, status: 'active' },
  { id: 'c3', name: 'Tafadzwa Chirwa', email: 'tafa.chirwa@gmail.com', phone: '+263 73 345 6789', nationalId: '85-3456789C00', dob: '1985-11-08', address: '7 Mutare Road, Mutare', occupation: 'Nurse', insurer: 'EcoSure', createdAt: '2024-02-20', policyCount: 1, status: 'active' },
  { id: 'c4', name: 'Patience Mukamuri', email: 'patience.m@yahoo.com', phone: '+263 78 456 7890', nationalId: '92-4567890D00', dob: '1992-05-30', address: '23 Gweru Drive, Gweru', occupation: 'Accountant', insurer: 'ZB Life', createdAt: '2024-03-12', policyCount: 2, status: 'active' },
  { id: 'c5', name: 'Garikai Mhike', email: 'garikai.mhike@gmail.com', phone: '+263 71 567 8901', nationalId: '70-5678901E00', dob: '1970-09-14', address: '89 Masvingo Road, Masvingo', occupation: 'Farmer', insurer: 'Nyaradzo Funeral', createdAt: '2024-03-28', policyCount: 1, status: 'inactive' },
  { id: 'c6', name: 'Rutendo Zvobgo', email: 'rutendo.z@gmail.com', phone: '+263 77 678 9012', nationalId: '88-6789012F00', dob: '1988-12-01', address: '34 Harare Gardens, Harare', occupation: 'Lawyer', insurer: 'Doves', createdAt: '2024-04-15', policyCount: 2, status: 'active' },
  { id: 'c7', name: 'Kudakwashe Muzenda', email: 'kuda.muzenda@gmail.com', phone: '+263 73 789 0123', nationalId: '95-7890123G00', dob: '1995-02-18', address: '56 Zvishavane Way, Zvishavane', occupation: 'Miner', insurer: 'Motions', createdAt: '2024-05-01', policyCount: 1, status: 'active' },
  { id: 'c8', name: 'Chiedza Hove', email: 'chiedza.h@gmail.com', phone: '+263 78 890 1234', nationalId: '82-8901234H00', dob: '1982-08-25', address: '12 Chitungwiza Ave, Chitungwiza', occupation: 'Social Worker', insurer: 'CBZ Life', createdAt: '2024-05-20', policyCount: 1, status: 'active' },
  { id: 'c9', name: 'Munyaradzi Gumbo', email: 'munya.gumbo@gmail.com', phone: '+263 71 901 2345', nationalId: '75-9012345I00', dob: '1975-04-10', address: '78 Chinhoyi Road, Chinhoyi', occupation: 'Driver', insurer: 'EcoSure', createdAt: '2024-06-08', policyCount: 2, status: 'active' },
  { id: 'c10', name: 'Tsitsi Manyonga', email: 'tsitsi.m@gmail.com', phone: '+263 77 012 3456', nationalId: '90-0123456J00', dob: '1990-06-15', address: '5 Norton Heights, Norton', occupation: 'Business Owner', insurer: 'ZB Life', createdAt: '2024-07-14', policyCount: 1, status: 'active' },
]
...
export const POLICIES: Policy[] = [
  ...
  },
  {
    ...
    beneficiaries: [
      { name: 'John Ndlovu', relationship: 'Spouse', percentage: 60, phone: '+263 77 222 3333' },
      { name: 'Thabo Ndlovu', relationship: 'Child', percentage: 40 },
    ],
...
export const TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    messages: [
      { id: 'm4', senderId: 'c4', senderName: 'Patience Mukamuri', message: 'Please help me update my beneficiary details.', timestamp: '2026-04-20T14:00:00Z', isStaff: false },
      { id: 'm5', senderId: 'u3', senderName: 'Blessing Moyo', message: 'Your beneficiary details have been updated successfully. You will receive a new policy schedule shortly.', timestamp: '2026-04-22T11:00:00Z', isStaff: true },
    ],
  },
]
